...
const messages = {
    ...
    random(messageType) { // this method works irrespective of the array length
        ...
        let max = this['_' + messageType].length
        let randomIndex = Math.floor(Math.random() * max)

        // return the random message based on the message type
        return this['_' + messageType][randomIndex]
    }
}

// list random messages of all message types
console.log(messages.random('compliments'))
console.log(messages.random('fortunes'))
console.log(messages.random('activities'))
...
console.log(quoteObj.quote + ' ~ ' + quoteObj.author)
console.log(messages.random('jokes'))
