const displayedMessage = document.querySelector('.text')
...
function getCompliment() {
    ...
    .then(res => res.json())
    .then(data => {console.log(displayedMessage.innerHTML = data.compliment)})
    .catch(error => {console.error('Error: ' + error)})
}
...
export { getActivity, getCompliment, getJoke }